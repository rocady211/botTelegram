...
def predict():
    ...
    equipo_A = request_data["equipo_A"]
    equipo_B = request_data["equipo_B"]
    es_local_A = request_data["es_local_A"]  # 1 = local, 0 = visitante
    clima = request_data["clima"]  # 0 = soleado, 1 = lluvioso
